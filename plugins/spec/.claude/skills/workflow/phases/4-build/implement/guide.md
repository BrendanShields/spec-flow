...
2. Generate test file:
   ```typescript
   // Auto-generated by spec:implement (TDD Mode)
...
Before delegating to spec:implementer, validate TDD compliance:
...
2. Invoke spec:implementer subagent with TDD context
