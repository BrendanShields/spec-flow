...
Last Updated: 2025-10-31 15:45:00
Generated by: metrics phase (verbose mode)
```
...
# Or explicit: metrics phase --export=csv --output=metrics.csv
```
...
**Related Skills**: analyze phase (feature-specific), spec:status (quick overview)
