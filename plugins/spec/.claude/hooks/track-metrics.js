 ...
 *
 * Metrics are saved to .spec/.metrics.json with historical snapshots in
 * .spec/metrics-history/ for trend analysis.
 *
 * @requires fs
 * @requires path
 * @requires crypto
...
const METRICS_FILE = '.spec/.metrics.json';
const METRICS_HISTORY_DIR = '.spec/metrics-history';
 ...
 * @param {string} context.command - Command executed (e.g., spec:implement)
