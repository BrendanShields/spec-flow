 ...
 * - AI-generated code (via Specter skills and Claude)
 * - Human-written code
 * - Modification patterns
 * - Development velocity
 * - Skill usage patterns
 *
 * Metrics are saved to .specter/.metrics.json with historical snapshots in
 * .specter/metrics-history/ for trend analysis.
 *
 * @requires fs
 * @requires path
 * @requires crypto
...
const METRICS_FILE = '.specter/.metrics.json';
const METRICS_HISTORY_DIR = '.specter/metrics-history';
 ...
 * @param {string} context.command - Command executed (e.g., specter:implement)
...
function generateMetricsSummary(metrics) {
  ...
  const summary = {
    type: 'metrics-update',
    message: `📊 Code Generation Metrics Update`,
    details: {
