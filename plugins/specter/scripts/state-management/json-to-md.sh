...
# Part of Specter v3.0 hybrid state management

set -euo pipefail

generate_session_md() {
    local json_file="${1:-.specter-state/session.json}"
    local output_file="${2:-.specter-state/current-session.md}"
...
*Auto-generated by Specter v3.0. Do not edit manually.*
...
generate_workflow_md() {
    local json_file="${1:-.specter-memory/workflow.json}"
    local output_file="${2:-.specter-memory/WORKFLOW-PROGRESS.md}"
